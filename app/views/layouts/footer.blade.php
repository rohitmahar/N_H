	   ...
	   <div class="footer_top">
		<div class="col-md-4 box_3">
			...
			<address class="address">
              <p>Kumaripati <br>Patan, Nepal</p>
              <dl>
                 <dt></dt>
                 <dd>Telephone:<span> 01-5538012</span></dd>
                 <dd>Store Opening and Closing Time:<br><span> 11:00am - 7:00pm</span></dd>
                 <dd>E-mail:&nbsp; <a href="mailto@example.com">info(at)buyshop.com</a></dd>
              </dl>
           </address>
           <ul class="footer_social">
			  <li><a href="https://www.facebook.com/DealsandStealsKTM?fref=ts"> <i class="fb"> </i> </a></li>
